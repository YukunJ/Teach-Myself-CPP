...
class Person final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::tutorial::Person_PhoneNumber>& _internal_phones() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::tutorial::Person_PhoneNumber>* _internal_mutable_phones();
  public:
...
class AddressBook final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::tutorial::Person>& _internal_people() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::tutorial::Person>* _internal_mutable_people();
  public:
...
inline ::tutorial::Person_PhoneNumber* Person::_internal_add_phones() {
  return _internal_mutable_phones()->Add();
}
...
inline ::tutorial::Person* AddressBook::_internal_add_people() {
  return _internal_mutable_people()->Add();
}
